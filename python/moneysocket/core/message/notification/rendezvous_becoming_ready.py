...
class NotifyRendezvousBecomingReady(MoneysocketNotification):
...
MoneysocketNotifcation.NOTIFICATION_SUBCLASSES[
    'NOTIFY_RENDEZVOUS_BECOMING_READY'] = NotifyRendezvousBecomingReady
