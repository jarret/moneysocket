...
class NfcLocation():
    NFC_LOCATION_TLV_TYPE = None

    def __init__(self, placeholder_string="nfc herpader"):
    ...
    @staticmethod
    def from_tlv(tlv):
        assert tlv.t == NfcLocation.NFC_LOCATION_TLV_TYPE
    ...
    def encode_tlv(self):
        ...
        return Tlv(NfcLocation.NFC_LOCATION_TLV_TYPE,
                   encoded).encode()
