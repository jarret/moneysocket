...
class WebRtcLocation():
    WEBRTC_LOCATION_TLV_TYPE = None

    def __init__(self, placeholder_string="webrtc herpader"):
    ...
    @staticmethod
    def from_tlv(tlv):
        assert tlv.t == WebRtcLocation.WEBRTC_LOCATION_TLV_TYPE
    ...
    def encode_tlv(self):
        ...
        return Tlv(WebRtcLocation.WEBRTC_LOCATION_TLV_TYPE, encoded).encode()
